# [FR]
# SystemResolver est un script Python permettant de résoudre des systèmes à 2 ou 3 équations
...
nbEqua = int(input("Combien votre système contient-il d'équations ?"))  # Variable du nombre d'équations du système
...
if (
    ...
    print(
        "[1ERE EQUATION] Entrez la valeur de la première inconnue de la première équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val1 = int(
        input()
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[1ERE EQUATION] Entrez la valeur de la deuxième inconnue de la première équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val2 = int(
        input()
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[2EME EQUATION] Entrez la valeur de la première inconnue de la deuxième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val3 = int(
        input()
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[2EME EQUATION] Entrez la valeur de la deuxième inconnue de la deuxième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val4 = int(
        input()
    ...
    print("=============================================")  # Encore un print
    print(
        "Vos inconnues sont respectivement égales à", x
...
if nbEqua == 3:
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[1ERE EQUATION] Entrez la valeur de la troisième inconnue de la première équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[2EME EQUATION] Entrez la valeur de la troisième inconnue de la deuxième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[3EME EQUATION] Entrez la valeur de la première inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val7 = int(input())  # voir au dessus
    print("-----------------------------------------------")  # Encore un print
    print(
        "[3EME EQUATION] Entrez la valeur de la deuxième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val8 = int(input())  # voir au dessus
    print("-----------------------------------------------")  # Encore un print
    print(
        "[3EME EQUATION] Entrez la valeur de la troisième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
...
if nbEqua == 4:
    ...
    val3 = int(input())  # voir au dessus
    print(
        "[1ERE EQUATION] Entrez la valeur de la quatrième inconnue de la première équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val4 = int(input())  # voir au dessus
    ...
    val7 = int(input())  # voir au dessus
    print(
        "[2EME EQUATION] Entrez la valeur de la quatrième inconnue de la deuxième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val8 = int(input())  # voir au dessus
    ...
    print(
        "[3EME EQUATION] Entrez la valeur de la quatrième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    ...
    print("-----------------------------------------------")  # Encore un print
    print(
        "[4EME EQUATION] Entrez la valeur de la première inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val13 = int(input())  # voir au dessus
    print("-----------------------------------------------")  # Encore un print
    print(
        "[4EME EQUATION] Entrez la valeur de la deuxième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val14 = int(input())  # voir au dessus
    print("-----------------------------------------------")  # Encore un print
    print(
        "[4EME EQUATION] Entrez la valeur de la troisième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
    val15 = int(input())  # voir au dessus
    print(
        "[4EME EQUATION] Entrez la valeur de la quatrième inconnue de la troisième équation (sans la lettre)"
    )  # Encore un print
    print("-----------------------------------------------")  # Encore un print
